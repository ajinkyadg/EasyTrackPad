...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private func setupStatusItem() {
        ...
        item.button?.image = NSImage(systemSymbolName: "hand.tap", accessibilityDescription: "InputCustomizerLite")
        ...
        menu.addItem(NSMenuItem.separator())
        menu.addItem(NSMenuItem(title: "Quit InputCustomizerLite", action: #selector(NSApplication.terminate(_:)), keyEquivalent: "q"))
        item.menu = menu
        statusItem = item
    }
        ...
        settingsStore.$isPaused
            .sink { [weak self] isPaused in
                ...
                self?.statusItem?.button?.image = NSImage(
                    ...
                    accessibilityDescription: "InputCustomizerLite"
                )
            }
    ...
    @objc private func openPreferences() {
        ...
        if preferencesWindow == nil {
            ...
            window.title = "InputCustomizerLite Preferences"
